            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="text-center" style="margin-bottom: 20%;">
                    <span style="text-decoration: underline; font-size: 19px;">Zvolený spôsob dopravy:</span><br>
                        <span><?php echo $doprava; ?></span><br><br>
                    <span style="text-decoration: underline; font-size: 19px;">Zvolený spôsob platby:</span><br>
                        <span><?php echo $platba; ?></span><br><br>
                    <span style="text-decoration: underline; font-size: 19px;">Celková cena objednávky: </span><br>
                    <span style="font-size: 24px; font-weight: bold; color: red; margin-bottom: 10%;"><?php  echo $total;?>€</span><br>
                    <div style="padding-top: 15px;" class="button-home">
