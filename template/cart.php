        ...
        foreach ($cart as $c)
        {
            ...
            <div style="margin: 0 25px;">
                <div class="d-flex justify-content-between">
                    <?php echo "<a style='color: black; font-size: 15px;' class='text-left' href='item.php?ID=".$c->product->p_id."'>".$c->product->p_nazov."</a>" ?>
                ...
                <p class="text-left"><?php if($c->product->p_sklad == 1){ echo "<span style='color: #149106'>Skladom</span>"; } ?></p>
