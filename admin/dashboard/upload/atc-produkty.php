<?php include "./main.php";	$link=DB_connect();
  ...
  function zapis_do_db_produkty($subor)
  {
    ...
    unset($arkat_gen); unset($arvyr_gen);
  }
  ...
  echo"Celkový čas sťahovania a spracovania <b>".round($time_end-$time_start)."</b> sekund(a).";
 	...
 	mysqli_query($link, "INSERT INTO `log` (`l_typ`,`l_sklad`,`l_priebeh`,`l_cas`,`l_datum`) VALUES ('1','<b>ATC</b><br>Produkty cele','".$log."','".round($time_end-$time_start)."','".date("YmdHis")."');");
