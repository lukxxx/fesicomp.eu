            ...
            <div class="row" style="padding: 40px" >
                <div class="col-sm-6 col-md-6 col-lg-6" style="border-right: 1px solid black;">
                    ...
                    <div class="categories">
                        <?php
                         ...
                         $sth = $pdo->prepare("SELECT * FROM vyrobcovia");
                         $sth->execute();
                        ...
                        <div class="category card " style="border: 1px solid #E7E7E7; padding: 10px; margin-bottom: 10px; background-color: white; box-shadow: 2px 2px 10px -2px #616161; border-radius: 20px;">
                            ...
                            <span style="padding-left: 10px;"><?php echo $v_id; ?> <b><?php echo $nazov_v; ?></b></span>
                                <form method="post" action="" >
                                
                                <button type="submit" name="set" value="<?php echo $v_id; ?>" class="btn" style="all:unset; cursor: pointer;"><i style="font-size: 20px" class="fas fa-cog"></i></button>
                                </form>
                            </div>
                        </div>
                        <?php } ?>       
                ...
                <div class="col-sm-6 col-md-6 col-lg-6" style="border-left: 1px solid black;">
                    ...
                    <?php if(isset($_POST['set'])){
                        ...
                        echo '<iframe style="width: 100%;border:none; height: 3%;" id="setting" name="setting" src="setting.php?set='.$_POST['set'].'" >&#160;</iframe>';
                        echo '<div class="d-flex align-left" style="margin-top: -142px">';
