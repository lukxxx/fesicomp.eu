...
<div class="container-fluid">
    <div class="row">
        ...
        <div  style="background-color: #F3F3F3; width: 100%; height: 1080px; margin-bottom: 40px; padding: 0 !important" class="col-sm-10 col-md-10 col-lg-10 scroll">
            <?php include "../../includes/header-temp.php"; ?>               
            <hr style="border: 1px solid black; margin-top: -5px; width: 95%;">
            <h6>Pre zobrazenie detailov o objednávke kliknite na ozubené koliesko</h6>
            <div class="row" style="padding: 40px" >
                    ...
                    <form method="post" action="">
                        <div class="form-group has-search search-box" style="position: relative;z-index: 2;">
                            ...
                            <input style="border-radius:30px;  outline: 0 !important; padding: 20px;" 
                                type="text" name="search" class="form-control search" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Hľadať objednávky...'" autocomplete="off" placeholder="  Hľadať objednávky..." >
                            <div class="result" style="display: none; margin-top: 10px"></div>
                                        
                        </div>
                    </form>
                    <hr style="border: 1px solid black; margin-top: -5px; width: 95%;">
                    <div class="categories" style="border: 1px solid #E7E7E7; padding: 20px; margin-bottom: 40px; background-color: white; box-shadow: 2px 2px 10px -2px #616161; border-radius: 20px;">
                        <h5></h5>
                        <table class="table table-sm" style="border-radius: 20px;">
                            <thead style="background-color: #717171; color: white">
                                <tr style="border-radius: 20px;">
                                <th style="text-align: left">ID objednávky</th>
                                <th style="text-align: left">Meno zákazníka</th>
                                <th style="text-align: left">Email</th>
                                <th style="text-align: center">Zaplatená</th>
                                <th style="text-align: center">Vybavená</th>
                                <th style="text-align: center">Info</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                $sth = $pdo->prepare("SELECT * FROM faktury");
                                $sth->execute();
                                ...
                                <th ><?php echo $id_objednavky ?></th>
                                <td><?php echo $meno." ".$priezvisko; ?></td>
                                <td><?php echo $email ?></td>
                                <td><?php echo $zaplatene ?></td>
                                <td><?php echo $vybavene ?></td>
                                <td style="text-align: center"><form method="post" action="" >
                                
                                <button type="submit" name="set" value="<?php echo $id_objednavky; ?>" class="btn" style="all:unset; cursor: pointer;"><i style="font-size: 20px" class="fas fa-cog"></i></button>
                                </form></td>
                                </tr>
                ...
                <div class="col-sm-6 col-md-6 col-lg-6" style="border-left: 1px solid black;">
                    ...
                    <?php if(isset($_POST['set'])){
                        ...
                        echo '<iframe style="width: 100%;border:none; height: 30%;" id="setting" name="setting" src="setting.php?set='.$_POST['set'].'" >&#160;</iframe>';
