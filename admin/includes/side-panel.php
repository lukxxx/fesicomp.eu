                ...
                <div class="col-sm-12 col-lg-12">
                    ...
                    <?php 
                        if (strpos($url,'/dashboard') !== false) {
                            echo '<a class="nav-link active-home" href="../"><i class="fas fa-home"></i><span> Domov</span></a>';
                        } else {
                    ...
                    <div class="home-link text-left">
                        ...
                        <?php 
                            ...
                            if (strpos($url,'/categories') !== false) {
                                echo '<a class="nav-link active" href="#"><i class="fas fa-list"></i><span> Kategórie</span></a>';
                            } else {
